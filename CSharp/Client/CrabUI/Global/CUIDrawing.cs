...
namespace CrabUI
{
  public partial class CUI
  {
    ...
    public static void DrawRectangle(SpriteBatch sb, CUIRect cuirect, Color cl, Texture2D texture, float depth = 0.0f)
    {
    ...
    public static void DrawRectangle(SpriteBatch sb, CUIRect cuirect, Color cl, CUISprite sprite, float depth = 0.0f)
    {
      ...
      Rectangle rect = sprite?.DrawMode switch
      {
      ...
      Rectangle sourceRect = sprite?.SourceRect ?? rect;
