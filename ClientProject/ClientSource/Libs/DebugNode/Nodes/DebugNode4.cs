...
namespace CUILibs
{
  ...
  {
    public static string DefaultMsgFactory(T1 arg1, T2 arg2, T3 arg3, T4 arg4) => $"{arg1}, {arg2}, {arg3}, {arg4}";
    public Func<T1, T2, T3, T4, string> MsgFactory { get; set; } = DefaultMsgFactory;
