...
namespace BaroJunk
{
  ...
  public class CustomReadOnlyListProxy_IReadOnlyListT<TSource, TResult> : IReadOnlyList<TResult>
  {
    public CustomReadOnlyListProxy_IReadOnlyListT(IReadOnlyList<TSource> source, Func<TSource, TResult> forward)
    {
      Source = source;
      Forward = forward;
    }
