...
namespace CrabUI
{
  public partial class CUIComponent
  {
    ...
    void IComponent.InjectModules()
    {
      ...
      As_CUIComponent.DragHandle.Host = As_CUIVisualComponent.Adapters.IDraggable;
      As_CUIComponent.SwipeHandle.Host = As_CUIVisualComponent.Adapters.ISwipeable;
      As_CUIComponent.LayoutMarker.Host = As_CUIVisualComponent.Adapters.LayoutMarker;
    }
