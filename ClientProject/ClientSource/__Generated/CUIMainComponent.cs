...
namespace CrabUI
{
  public partial class CUIMainComponent
  {
    ...
    {
      As_CUIMainComponent.RightResizeHandle.Host = As_CUIVisualComponent.Adapters.IResizable;
      As_CUIMainComponent.DragHandle.Host = As_CUIVisualComponent.Adapters.IDraggable;
      As_CUIMainComponent.SwipeHandle.Host = As_CUIVisualComponent.Adapters.ISwipeable;
      As_CUIMainComponent.LayoutMarker.Host = As_CUIVisualComponent.Adapters.LayoutMarker;
    }
